namespace BookShopSystem.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BookShopContext>
    {
        ...
        private static void SeedCategories(BookShopContext context)
        {
            ...
            string[] categories = File.ReadAllLines("D:\\VisualStudio2015\\Projects\\EntityFramework\\06.EntityRelationsAdv\\06.EFRelationAdvance\\BookShopSystem\\Import\\categories.csv");
        ...
        private static void SeedBooks(BookShopContext context)
        {
            ...
            string[] books= File.ReadAllLines("D:\\VisualStudio2015\\Projects\\EntityFramework\\06.EntityRelationsAdv\\06.EFRelationAdvance\\BookShopSystem\\Import\\books.csv");
        ...
        {
            string[] authors = File.ReadAllLines("D:\\VisualStudio2015\\Projects\\EntityFramework\\06.EntityRelationsAdv\\06.EFRelationAdvance\\BookShopSystem\\Import\\authors.csv");
